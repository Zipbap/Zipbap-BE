...
import zipbap.app.global.ApiResponse as GlobalApiResponse
...
interface CookingTypeDocs {
    ...
    ): GlobalApiResponse<CookingTypeResponseDto>
    ...
    @GetMapping
    fun getAllCookingTypes(): GlobalApiResponse<List<CookingTypeResponseDto>>
